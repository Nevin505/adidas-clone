  ...
  return (
    <main>
      <div className="max-container flex flex-col items-center ">
          ...
          <div className="w-full  relative">
            ...
            <div className=" flex flex-col gap-8 w-3/5  absolute bottom-8 left-8 lg:w-96 lg:left-16 ">
              ...
              <p className="text-white max-[500px]:text-sm">
                Enter the adiClub Pro Pass Draw For Your Chance to win
                next-level Trip tp Paris
              </p>
              <Row>
        ...
        <h1 className="font-bold text-start w-full text-xl px-4  py-8 md:px-16  md:text-3xl">
          WHAT'S HOT?
        </h1>
        <CommonCarousel showControls="buttons">
        ...
        <div className="w-full  flex  flex-wrap justify-center items-center gap-4 bg-yellow-200 text-center p-8">
          ...
          <div className="  p-4 idd relative ">
            <button className="flex gap-4 items-center font-bold px-4 py-1 bg-black text-white  hover:text-slate-200">
              SIGN UP FOR FREE
              <span className="leftbar">
                <FaLongArrowAltRight className="text-white  " size={40} />
              </span>
            </button>
          </div>
        </div>
