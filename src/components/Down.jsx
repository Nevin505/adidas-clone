...
const Down = ({onClick}) => {
  ...
  return (
    <div className="w-full flex justify-center border-2  border-blue-700 fixed   bg-white z-10 " >
            <button className="self-start" onClick={onClick}><IoClose/></button>

            <div className="flex  flex-wrap text-black w-4/5 gap-16 py-24 max-[900px]:py-1  max-[900px]:gap-1">
           ...
           <div className="flex-1 basis-64 max-[900px]:py-1">
             ...
             <div className="flex-1 basis-32 max-[900px]:py-1`">
